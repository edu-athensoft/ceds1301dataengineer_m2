...
class TestMySQLUtil(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        # Create a database
        self.util.execute('create database if not exists chapter_2_3_3_log default charset=utf8;')
        # Create a test data table
        self.util.execute('create table if not exists chapter_2_3_3_log.students(id int, name varchar(20));')

    def tearDown(self) -> None:
        # Delete the data table created by setUp
        self.util.execute('drop table if exists chapter_2_3_3_log.students;')
        # Delete the test database created by setUp
        self.util.execute('drop database if exists chapter_2_3_3_log;')
    ...
    def test_insert_single_sql(self):
        ...
        :return:
        """
        self.util.insert_sql('insert into chapter_2_3_3_log.students values (1, "Tom");')
        result = self.util.query_all(db_name='chapter_2_3_3_log', tb_name='students')  # ((), (), ())
