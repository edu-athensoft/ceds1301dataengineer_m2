...
logger = logging_util.init_logger('dim_motor_status_generate')
logger.info('dim_motor_status_generate started....')
...
target_util.check_table_exists_and_create(
    ...
    tb_name=conf.target_dim_motor_status_table_name,
    tb_cols=conf.target_dim_motor_status_table_create_cols
)
...
cursor.executemany('''
INSERT INTO dim_motor_status (name, type) 
VALUES (%s, %s)
''', data)
...
logger.info("Data inserted successfully into dim_motor_status table")
