"""
ads_car_alarm_stats collection tools
"""
import time
...
if not source_util.check_table_exists(conf.source_data_db, conf.source_dws_car_alarm_stats_d_table_name):
...
source_car_alarm_stats_table_results = source_util.query(conf.target_ads_car_alarm_stats_table_select_sql)
...
target_util.check_table_exists_and_create(
    ...
    tb_name=conf.target_ads_car_alarm_stats_table_name,
    tb_cols=conf.target_ads_car_alarm_stats_table_create_cols
)

source_util.query(conf.target_ads_car_alarm_stats_table_delete_sql)
